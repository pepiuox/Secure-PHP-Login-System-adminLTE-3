                        ...
                        <div class="f-about">
                            <div class="footer-logo">
                                <a href="javascript:void(0)">
                                    <img src="<?php echo $base; ?>plugins/images/footer/logo.svg" alt="Logo" />
                                </a>
                            </div>
                            <p class="text">
                        ...
                        <div class="footer-app-store">
                            ...
                            <ul>
                                <li>
                                    <a href="javascript:void(0)">
                                        <img
                                            src="<?php echo $base; ?>plugins/images/footer/app-store.svg"
                                            alt="app"
                                            />
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)">
                                        <img
                                            src="<?php echo $base; ?>plugins/images/footer/play-store.svg"
                                            alt="play"
                                            />
                                    </a>
                                </li>
