    ...
    if (isset($_GET['id']) && !empty($_GET['id'])) {
        ...
        <html lang="en">
            <head>
                ...
                <script src="<?php echo $base; ?>plugins/js/toastr.min.js"></script>
                <script src="<?php echo $base; ?>plugins/grapesjs/js/grapes.min.js"></script>
                <script src="<?php echo $base; ?>plugins/grapesjs/js/grapesjs-bootstrap-elements.js"></script>
                <script src="<?php echo $base; ?>plugins/ckeditor/ckeditor.js"></script>                
                <script src="<?php echo $base; ?>plugins/grapesjs/js/grapesjs-preset-webpage.min.js"></script>
                <script src="<?php echo $base; ?>plugins/grapesjs/js/grapesjs-lory-slider.min.js"></script>
                <script src="<?php echo $base; ?>plugins/grapesjs/js/grapesjs-tabs.min.js"></script>
                <script src="<?php echo $base; ?>plugins/grapesjs/js/grapesjs-component-code-editor.min.js" type="text/javascript"></script>
                <script src="<?php echo $base; ?>plugins/grapesjs/js/grapesjs-custom-code.min.js"></script>
                <script src="<?php echo $base; ?>plugins/grapesjs/js/grapesjs-touch.min.js"></script>
                <script src="<?php echo $base; ?>plugins/grapesjs/js/grapesjs-parser-postcss.min.js"></script>
                <script src="<?php echo $base; ?>plugins/grapesjs/js/grapesjs-tooltip.min.js"></script>
                <script src="<?php echo $base; ?>plugins/grapesjs/js/grapesjs-tui-image-editor.min.js"></script>
                <script src="<?php echo $base; ?>plugins/grapesjs/js/grapesjs-navbar.min.js"></script>
                <script src="<?php echo $base; ?>plugins/grapesjs/js/grapesjs-blocks-bootstrap4.min.js"></script>
                <script src="<?php echo $base; ?>plugins/grapesjs/js/grapesjs-code-editor.min.js"></script>
